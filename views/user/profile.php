...
<div class="container profilecols">
	<div class="row">
			...
			<div class="tabnav">
				<div class="button-controls">
					<div class="button-controls-right">
						<?php echo HTML::anchor('user/edit', '<i class="icon-pencil"></i> '.__('Edit Account'), array('class' => 'pull-right btn')); ?>
						<?php echo HTML::anchor('user/password', '<i class="icon-cog"></i> '.__('Change Password'), array('class' => 'pull-right btn')); ?>
					</div>
				</div>
			</div>
		</div>
